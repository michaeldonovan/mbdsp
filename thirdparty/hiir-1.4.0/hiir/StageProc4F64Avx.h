...
public:
    static hiir_FORCEINLINE void process_sample_pos(const int nbr_coefs, __m256d &spl_0,
                                                    __m256d &spl_1,
                                                    StageDataF64Avx *stage_arr) noexcept;
    static hiir_FORCEINLINE void process_sample_neg(const int nbr_coefs, __m256d &spl_0,
                                                    __m256d &spl_1,
                                                    StageDataF64Avx *stage_arr) noexcept;
...
private:
    ...
    ~StageProc4F64Avx() = delete;
    StageProc4F64Avx<REMAINING> &operator=(const StageProc4F64Avx<REMAINING> &other) = delete;
    StageProc4F64Avx<REMAINING> &operator=(StageProc4F64Avx<REMAINING> &&other) = delete;
