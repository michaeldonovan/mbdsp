...
template <int NC>
PhaseHalfPi4Neon<NC>::PhaseHalfPi4Neon() noexcept : _bifilter(), _phase(0)
{
...
template <int NC>
void PhaseHalfPi4Neon<NC>::process_sample(float32x4_t &out_0, float32x4_t &out_1,
                                          float32x4_t input) noexcept
{
    out_0 = input;          // Even coefs
    out_1 = load4a(_prev);  // Odd coefs

    StageProc4Neon<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1, &_bifilter[_phase][0]);
...
template <int NC>
void PhaseHalfPi4Neon<NC>::process_block(float out_0_ptr[], float out_1_ptr[], const float in_ptr[],
                                         long nbr_spl) noexcept
{
    ...
    while(pos < end)
    {
        ...
        auto out_0 = input_0;
        auto out_1 = prev;
        StageProc4Neon<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1, &_bifilter[0][0]);
        ...
        out_0 = input_1;
        out_1 = input_0;  // prev
        StageProc4Neon<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1, &_bifilter[1][0]);
