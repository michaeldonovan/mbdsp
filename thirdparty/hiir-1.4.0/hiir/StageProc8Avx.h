...
public:
    static hiir_FORCEINLINE void process_sample_pos(const int nbr_coefs, __m256 &spl_0,
                                                    __m256 &spl_1,
                                                    StageDataAvx *stage_arr) noexcept;
    static hiir_FORCEINLINE void process_sample_neg(const int nbr_coefs, __m256 &spl_0,
                                                    __m256 &spl_1,
                                                    StageDataAvx *stage_arr) noexcept;
...
private:
    ...
    ~StageProc8Avx() = delete;
    StageProc8Avx<REMAINING> &operator=(const StageProc8Avx<REMAINING> &other) = delete;
    StageProc8Avx<REMAINING> &operator=(StageProc8Avx<REMAINING> &&other) = delete;
