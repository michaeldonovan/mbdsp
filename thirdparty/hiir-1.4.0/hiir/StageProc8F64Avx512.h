...
public:
    static hiir_FORCEINLINE void process_sample_pos(const int nbr_coefs, __m512d &spl_0,
                                                    __m512d &spl_1,
                                                    StageDataF64Avx512 *stage_arr) noexcept;
    static hiir_FORCEINLINE void process_sample_neg(const int nbr_coefs, __m512d &spl_0,
                                                    __m512d &spl_1,
                                                    StageDataF64Avx512 *stage_arr) noexcept;
...
private:
    ...
    ~StageProc8F64Avx512() = delete;
    StageProc8F64Avx512<REMAINING> &operator=(const StageProc8F64Avx512<REMAINING> &other) = delete;
    StageProc8F64Avx512<REMAINING> &operator=(StageProc8F64Avx512<REMAINING> &&other) = delete;
