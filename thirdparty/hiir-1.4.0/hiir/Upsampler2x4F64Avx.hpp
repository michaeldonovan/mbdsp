...
template <int NC>
Upsampler2x4F64Avx<NC>::Upsampler2x4F64Avx() noexcept : _filter()
{
...
void Upsampler2x4F64Avx<NC>::process_sample(__m256d &out_0, __m256d &out_1, __m256d input) noexcept
{
    __m256d even = input;
    __m256d odd = input;
    StageProc4F64Avx<NBR_COEFS>::process_sample_pos(NBR_COEFS, even, odd, &_filter[0]);
    out_0 = even;
    out_1 = odd;
}
...
template <int NC>
void Upsampler2x4F64Avx<NC>::process_block(double out_ptr[], const double in_ptr[],
