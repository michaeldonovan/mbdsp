...
template <int NC>
Downsampler2x8Avx<NC>::Downsampler2x8Avx() noexcept : _filter()
{
...
void Downsampler2x8Avx<NC>::set_coefs(const double coef_arr[]) noexcept
{
    ...
    {
        _mm256_store_ps(_filter[i + 2]._coef, _mm256_set1_ps(DataType(coef_arr[i])));
    }
}
...
__m256 Downsampler2x8Avx<NC>::process_sample(__m256 in_0, __m256 in_1) noexcept
{
    ...
    StageProc8Avx<NBR_COEFS>::process_sample_pos(NBR_COEFS, spl_0, spl_1, &_filter[0]);
...
template <int NC>
void Downsampler2x8Avx<NC>::process_block(float out_ptr[], const float in_ptr[],
...
template <int NC>
void Downsampler2x8Avx<NC>::process_sample_split(__m256 &low, __m256 &high,
...
template <int NC>
void Downsampler2x8Avx<NC>::process_sample_split(__m256 &low, __m256 &high, __m256 in_0,
                                                 __m256 in_1) noexcept
{
    __m256 spl_0 = in_1;
    __m256 spl_1 = in_0;
...
template <int NC>
void Downsampler2x8Avx<NC>::process_block_split(float out_l_ptr[], float out_h_ptr[],
