...
template <int NC>
Downsampler2x8F64Avx512<NC>::Downsampler2x8F64Avx512() noexcept : _filter()
{
...
void Downsampler2x8F64Avx512<NC>::set_coefs(const double coef_arr[]) noexcept
{
    ...
    {
        _mm512_store_pd(_filter[i + 2]._coef, _mm512_set1_pd(DataType(coef_arr[i])));
    }
}
...
__m512d Downsampler2x8F64Avx512<NC>::process_sample(__m512d in_0, __m512d in_1) noexcept
{
    ...
    StageProc8F64Avx512<NBR_COEFS>::process_sample_pos(NBR_COEFS, spl_0, spl_1, &_filter[0]);
...
template <int NC>
void Downsampler2x8F64Avx512<NC>::process_block(double out_ptr[], const double in_ptr[],
...
template <int NC>
void Downsampler2x8F64Avx512<NC>::process_sample_split(__m512d &low, __m512d &high,
...
template <int NC>
void Downsampler2x8F64Avx512<NC>::process_sample_split(__m512d &low, __m512d &high, __m512d in_0,
                                                       __m512d in_1) noexcept
{
    __m512d spl_0 = in_1;
    __m512d spl_1 = in_0;
...
template <int NC>
void Downsampler2x8F64Avx512<NC>::process_block_split(double out_l_ptr[], double out_h_ptr[],
