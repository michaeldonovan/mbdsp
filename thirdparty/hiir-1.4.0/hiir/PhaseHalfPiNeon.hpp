...
template <int NC>
PhaseHalfPiNeon<NC>::PhaseHalfPiNeon() noexcept : _filter(), _prev(0), _phase(0)
{
...
template <int NC>
hiir_FORCEINLINE void PhaseHalfPiNeon<NC>::process_sample(float &out_0, float &out_1,
...
template <int NC>
void PhaseHalfPiNeon<NC>::process_block(float out_0_ptr[], float out_1_ptr[], const float in_ptr[],
                                        long nbr_spl) noexcept
{
    ...
    if(nbr_spl > 0)
    {
        const long n4 = process_block_quad(out_0_ptr, out_1_ptr, in_ptr, nbr_spl);
...
template <int NC>
long PhaseHalfPiNeon<NC>::process_block_quad(float out_0_ptr[], float out_1_ptr[],
