...
template <int NC>
HalfBand16Avx512<NC>::HalfBand16Avx512() noexcept : _bifilter(), _phase(0)
{
...
template <int NC>
void HalfBand16Avx512<NC>::process_block(float out_ptr[], const float in_ptr[],
...
template <int NC>
void HalfBand16Avx512<NC>::process_block_hpf(float out_ptr[], const float in_ptr[],
                                             long nbr_spl) noexcept
{
    assert(out_ptr != nullptr);
    assert(out_ptr <= in_ptr || out_ptr >= in_ptr + nbr_spl * _nbr_chn);
...
template <int NC>
void HalfBand16Avx512<NC>::process_block_split(float out_l_ptr[], float out_h_ptr[],
...
typename HalfBand16Avx512<NC>::EvenOdd HalfBand16Avx512<NC>::process_2_paths(__m512 input) noexcept
{
    ...
    StageProc16Avx512<NBR_COEFS>::process_sample_pos(NBR_COEFS, path_arr._e, path_arr._o,
                                                     &_bifilter[_phase][0]);
...
void HalfBand16Avx512<NC>::process_block_2_paths(float out_l_ptr[], float out_h_ptr[],
                                                 ...
                                                 FH fnc_h) noexcept
{
    ...
    while(pos < end)
    {
        ...
        auto tmp_0 = input_0;
        auto tmp_1 = prev;
        StageProc16Avx512<NBR_COEFS>::process_sample_pos(NBR_COEFS, tmp_0, tmp_1, &_bifilter[0][0]);

        auto tmp_2 = input_1;
        auto tmp_3 = input_0;  // prev
        StageProc16Avx512<NBR_COEFS>::process_sample_pos(NBR_COEFS, tmp_2, tmp_3, &_bifilter[1][0]);
