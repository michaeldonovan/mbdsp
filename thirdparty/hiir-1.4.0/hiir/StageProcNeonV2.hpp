...
template <int CUR>
void StageProcNeonV2<CUR>::process_sample_pos_rec(float32x2_t &x,
                                                  StageDataNeonV2 *stage_ptr) noexcept
{
    ...
    x = vmla_f32(tmp, x - load2a(stage_ptr[CUR]._mem), load2a(stage_ptr[CUR]._coef));
}

template <>
hiir_FORCEINLINE void StageProcNeonV2<0>::process_sample_pos_rec(
    float32x2_t & /* x */, StageDataNeonV2 * /* stage_ptr */) noexcept
{
    // Nothing, stops the recursion
}

template <int CUR>
void StageProcNeonV2<CUR>::process_sample_neg_rec(float32x2_t &x,
                                                  StageDataNeonV2 *stage_ptr) noexcept
{
...
template <>
hiir_FORCEINLINE void StageProcNeonV2<0>::process_sample_neg_rec(
    float32x2_t & /* x */, StageDataNeonV2 * /* stage_ptr */) noexcept
{
    // Nothing, stops the recursion
}
