...
public:
    ...
    Downsampler2x3dnow<NC> &operator=(const Downsampler2x3dnow<NC> &other) = default;
    Downsampler2x3dnow<NC> &operator=(Downsampler2x3dnow<NC> &&other) = default;
...
private:
    ...
    typedef std::array<StageData3dnow, _nbr_stages + 1>
