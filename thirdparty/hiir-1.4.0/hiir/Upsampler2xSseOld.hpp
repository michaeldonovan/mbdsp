...
template <int NC>
Upsampler2xSseOld<NC>::Upsampler2xSseOld() noexcept : _filter()
{
...
template <int NC>
void Upsampler2xSseOld<NC>::process_block(float out_ptr[], const float in_ptr[],
...
template <int NC>
long Upsampler2xSseOld<NC>::process_block_quad(float out_ptr[], const float in_ptr[],
                                               long nbr_spl) noexcept
{
