...
template <int NC>
HalfBand4F64Avx<NC>::HalfBand4F64Avx() noexcept : _bifilter(), _phase(0)
{
...
template <int NC>
void HalfBand4F64Avx<NC>::process_block(double out_ptr[], const double in_ptr[],
...
template <int NC>
void HalfBand4F64Avx<NC>::process_block_hpf(double out_ptr[], const double in_ptr[],
                                            long nbr_spl) noexcept
{
    assert(out_ptr != nullptr);
    assert(out_ptr <= in_ptr || out_ptr >= in_ptr + nbr_spl * _nbr_chn);
...
template <int NC>
void HalfBand4F64Avx<NC>::process_block_split(double out_l_ptr[], double out_h_ptr[],
...
typename HalfBand4F64Avx<NC>::EvenOdd HalfBand4F64Avx<NC>::process_2_paths(__m256d input) noexcept
{
    ...
    StageProc4F64Avx<NBR_COEFS>::process_sample_pos(NBR_COEFS, path_arr._e, path_arr._o,
                                                    &_bifilter[_phase][0]);
...
void HalfBand4F64Avx<NC>::process_block_2_paths(double out_l_ptr[], double out_h_ptr[],
                                                ...
                                                FH fnc_h) noexcept
{
    ...
    while(pos < end)
    {
        ...
        auto tmp_0 = input_0;
        auto tmp_1 = prev;
        StageProc4F64Avx<NBR_COEFS>::process_sample_pos(NBR_COEFS, tmp_0, tmp_1, &_bifilter[0][0]);

        auto tmp_2 = input_1;
        auto tmp_3 = input_0;  // prev
        StageProc4F64Avx<NBR_COEFS>::process_sample_pos(NBR_COEFS, tmp_2, tmp_3, &_bifilter[1][0]);
