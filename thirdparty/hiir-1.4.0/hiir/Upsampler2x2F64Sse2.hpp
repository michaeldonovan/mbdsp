...
template <int NC>
Upsampler2x2F64Sse2<NC>::Upsampler2x2F64Sse2() noexcept : _filter()
{
...
void Upsampler2x2F64Sse2<NC>::process_sample(__m128d &out_0, __m128d &out_1, __m128d input) noexcept
{
    __m128d even = input;
    __m128d odd = input;
    StageProc2F64Sse2<NBR_COEFS>::process_sample_pos(NBR_COEFS, even, odd, &_filter[0]);
    out_0 = even;
    out_1 = odd;
}
...
template <int NC>
void Upsampler2x2F64Sse2<NC>::process_block(double out_ptr[], const double in_ptr[],
