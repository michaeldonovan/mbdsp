...
template <int NC>
Upsampler2xNeonOld<NC>::Upsampler2xNeonOld() noexcept : _filter()
{
    for(int i = 0; i < _nbr_stages + 1; ++i) { storea(_filter[i]._coef, vdupq_n_f32(0)); }
...
template <int NC>
void Upsampler2xNeonOld<NC>::process_block(float out_ptr[], const float in_ptr[],
...
template <int NC>
long Upsampler2xNeonOld<NC>::process_block_quad(float out_ptr[], const float in_ptr[],
                                                long nbr_spl) noexcept
{
    ...
    for(long pos = 0; pos < n4; pos += 4)
    {
        ...
        auto y_0 = vcombine_f32(vget_high_f32(y_3), vdup_lane_f32(vget_low_f32(x), 0));
        ...
        auto y_1 = vcombine_f32(vget_high_f32(y_0), vdup_lane_f32(vget_low_f32(x), 1));
        ...
        auto y_2 = vcombine_f32(vget_high_f32(y_1), vdup_lane_f32(vget_high_f32(x), 0));
        ...
        y_3 = vcombine_f32(vget_high_f32(y_2), vdup_lane_f32(vget_high_f32(x), 1));
        ...
        const auto y_01 =
            vcombine_f32(vrev64_f32(vget_low_f32(y_0)), vrev64_f32(vget_low_f32(y_1)));
        const auto y_23 =
            vcombine_f32(vrev64_f32(vget_low_f32(y_2)), vrev64_f32(vget_low_f32(y_3)));
