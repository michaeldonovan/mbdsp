...
template <int CUR>
void StageProcNeonV4<CUR>::process_sample_pos(StageDataNeonV4 *stage_ptr, float32x4_t &y,
                                              float32x4_t &mem) noexcept
{
...
template <int CUR>
void StageProcNeonV4<CUR>::process_sample_neg(StageDataNeonV4 *stage_ptr, float32x4_t &y,
                                              float32x4_t &mem) noexcept
{
...
template <int CUR>
void StageProcNeonV4<CUR>::process_sample_pos_rec(StageDataNeonV4 *stage_ptr, float32x4_t &y,
                                                  float32x4_t &mem) noexcept
{
...
template <>
hiir_FORCEINLINE void StageProcNeonV4<0>::process_sample_pos_rec(StageDataNeonV4 * /* stage_ptr */,
                                                                 float32x4_t & /* y */,
                                                                 float32x4_t & /* mem */) noexcept
{
...
template <int CUR>
void StageProcNeonV4<CUR>::process_sample_neg_rec(StageDataNeonV4 *stage_ptr, float32x4_t &y,
                                                  float32x4_t &mem) noexcept
{
...
template <>
hiir_FORCEINLINE void StageProcNeonV4<0>::process_sample_neg_rec(StageDataNeonV4 * /* stage_ptr */,
                                                                 float32x4_t & /* y */,
                                                                 float32x4_t & /* mem */) noexcept
{
    // Nothing, stops the recursion
