...
public:
    static hiir_FORCEINLINE void process_sample_pos(StageDataSse *stage_ptr, __m128 &y,
                                                    __m128 &mem) noexcept;
    static hiir_FORCEINLINE void process_sample_neg(StageDataSse *stage_ptr, __m128 &y,
                                                    __m128 &mem) noexcept;
...
private:
    ...
    ~StageProcSseV4() = delete;
    StageProcSseV4<CUR> &operator=(const StageProcSseV4<CUR> &other) = delete;
    StageProcSseV4<CUR> &operator=(StageProcSseV4<CUR> &&other) = delete;
