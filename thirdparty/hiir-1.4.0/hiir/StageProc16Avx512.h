...
public:
    static hiir_FORCEINLINE void process_sample_pos(const int nbr_coefs, __m512 &spl_0,
                                                    __m512 &spl_1,
                                                    StageDataAvx512 *stage_arr) noexcept;
    static hiir_FORCEINLINE void process_sample_neg(const int nbr_coefs, __m512 &spl_0,
                                                    __m512 &spl_1,
                                                    StageDataAvx512 *stage_arr) noexcept;
...
private:
    ...
    ~StageProc16Avx512() = delete;
    StageProc16Avx512<REMAINING> &operator=(const StageProc16Avx512<REMAINING> &other) = delete;
    StageProc16Avx512<REMAINING> &operator=(StageProc16Avx512<REMAINING> &&other) = delete;
