...
public:
    ...
    hiir_FORCEINLINE void process_sample(DataType &out_0, DataType &out_1, DataType input) noexcept;
    void process_block(DataType out_0_ptr[], DataType out_1_ptr[], const DataType in_ptr[],
