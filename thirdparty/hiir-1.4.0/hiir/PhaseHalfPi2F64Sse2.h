...
public:
    ...
    PhaseHalfPi2F64Sse2<NC> &operator=(const PhaseHalfPi2F64Sse2<NC> &other) = default;
    PhaseHalfPi2F64Sse2<NC> &operator=(PhaseHalfPi2F64Sse2<NC> &&other) = default;

    void set_coefs(const double coef_arr[]) noexcept;

    hiir_FORCEINLINE void process_sample(__m128d &out_0, __m128d &out_1, __m128d input) noexcept;
