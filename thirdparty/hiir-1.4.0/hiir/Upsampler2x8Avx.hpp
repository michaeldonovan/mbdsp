...
template <int NC>
Upsampler2x8Avx<NC>::Upsampler2x8Avx() noexcept : _filter()
{
...
void Upsampler2x8Avx<NC>::process_sample(__m256 &out_0, __m256 &out_1, __m256 input) noexcept
{
    __m256 even = input;
    __m256 odd = input;
    StageProc8Avx<NBR_COEFS>::process_sample_pos(NBR_COEFS, even, odd, &_filter[0]);
    out_0 = even;
    out_1 = odd;
}
...
template <int NC>
void Upsampler2x8Avx<NC>::process_block(float out_ptr[], const float in_ptr[],
