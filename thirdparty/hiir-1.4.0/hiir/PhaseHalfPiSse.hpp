...
template <int NC>
PhaseHalfPiSse<NC>::PhaseHalfPiSse() noexcept : _filter(), _prev(0), _phase(0)
{
...
template <int NC>
hiir_FORCEINLINE void PhaseHalfPiSse<NC>::process_sample(float &out_0, float &out_1,
...
template <int NC>
void PhaseHalfPiSse<NC>::process_block(float out_0_ptr[], float out_1_ptr[], const float in_ptr[],
...
template <int NC>
long PhaseHalfPiSse<NC>::process_block_quad(float out_0_ptr[], float out_1_ptr[],
