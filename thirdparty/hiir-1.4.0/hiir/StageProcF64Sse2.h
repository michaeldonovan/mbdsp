...
public:
    static hiir_FORCEINLINE void process_sample_pos(__m128d &x,
                                                    StageDataF64Sse2 *stage_arr) noexcept;
    static hiir_FORCEINLINE void process_sample_neg(__m128d &x,
                                                    StageDataF64Sse2 *stage_arr) noexcept;

    static hiir_FORCEINLINE void process_sample_pos_rec(__m128d &x,
                                                        StageDataF64Sse2 *stage_arr) noexcept;
    static hiir_FORCEINLINE void process_sample_neg_rec(__m128d &x,
                                                        StageDataF64Sse2 *stage_arr) noexcept;
...
private:
    ...
    ~StageProcF64Sse2() = delete;
    StageProcF64Sse2 &operator=(const StageProcF64Sse2 &other) = delete;
    StageProcF64Sse2 &operator=(StageProcF64Sse2 &&other) = delete;
