...
public:
    ...
    inline EmbeddedType& use() { return _obj; }
    inline const EmbeddedType& use() const { return _obj; }
...
public:
    ...
    inline EmbeddedType &use();
    inline const EmbeddedType &use() const;
...
private:
    ...
    AlignedObject<T> &operator=(const AlignedObject<T> &other) = delete;
    AlignedObject<T> &operator=(AlignedObject<T> &&other) = delete;
