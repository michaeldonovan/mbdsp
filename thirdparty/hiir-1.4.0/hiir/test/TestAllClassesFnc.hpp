...
int TestAllClassesFnc<NC>::perform_test(double transition_bw)
{
    ...
    fflush(stdout);
    PolyphaseIir2Designer::compute_coefs_spec_order_tbw(&coef_arr[0], NBR_COEFS, transition_bw);
    printf("Done.\n");
    const double stopband_at =
        PolyphaseIir2Designer::compute_atten_from_order_tbw(NBR_COEFS, transition_bw);
    ...
    if(ret_val == 0)
    {
        ...
        TestedType dspl;
        ret_val = TestHalfBand<TestedType>::perform_test(dspl, coef_arr, ss, "fpu", transition_bw,
                                                         stopband_at);
    }
    ...
    if(ret_val == 0)
    {
        ...
        TestedType dspl;
        ret_val = TestDownsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "fpu",
                                                              transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0)
    {
        ...
        TestedType dspl;
        ret_val = TestUpsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "fpu",
                                                            transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0)
    {
        ...
        TestedType dspl;
        ret_val =
            TestPhaseHalfPi<TestedType>::perform_test(dspl, coef_arr, ss, "fpu", transition_bw);
    }
    ...
    if(ret_val == 0 && cpu._3dnow_flag)
    {
        ...
        TestedType dspl;
        ret_val = TestDownsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "3dnow",
                                                              transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._3dnow_flag)
    {
        ...
        TestedType dspl;
        ret_val = TestUpsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "3dnow",
                                                            transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._3dnow_flag)
    {
        ...
        TestedType dspl;
        ret_val =
            TestPhaseHalfPi<TestedType>::perform_test(dspl, coef_arr, ss, "3dnow", transition_bw);
    }
#endif
    ...
    if(ret_val == 0 && cpu._sse_flag)
    {
        ...
        ret_val = TestHalfBand<TestedType>::perform_test(dspl, coef_arr, ss, "sse", transition_bw,
                                                         stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._sse_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestDownsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "sseO",
                                                              transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._sse_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestDownsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "sse",
                                                              transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._sse_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestUpsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "sse",
                                                            transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._sse_flag)
    {
        ...
        TestedType &dspl = container.use();
        ret_val =
            TestPhaseHalfPi<TestedType>::perform_test(dspl, coef_arr, ss, "sse", transition_bw);
    }
    ...
    if(ret_val == 0 && cpu._sse2_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestHalfBand<TestedType>::perform_test(dspl, coef_arr, ss, "sse2", transition_bw,
                                                         stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._sse2_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestDownsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "sse2",
                                                              transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._sse2_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestUpsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "sse2",
                                                            transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._sse2_flag)
    {
        ...
        TestedType &dspl = container.use();
        ret_val =
            TestPhaseHalfPi<TestedType>::perform_test(dspl, coef_arr, ss, "sse2", transition_bw);
    }
    ...
    if(ret_val == 0 && cpu._avx_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestHalfBand<TestedType>::perform_test(dspl, coef_arr, ss, "avx", transition_bw,
                                                         stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._avx_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestDownsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "avx",
                                                              transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._avx_flag)
    {
        ...
        TestedType &dspl = container.use();
        ret_val =
            TestPhaseHalfPi<TestedType>::perform_test(dspl, coef_arr, ss, "avx", transition_bw);
    }
    ...
    if(ret_val == 0 && cpu._avx_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestUpsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "avx",
                                                            transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._avx512f_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestHalfBand<TestedType>::perform_test(dspl, coef_arr, ss, "avx512",
                                                         transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._avx512f_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestDownsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "avx512",
                                                              transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._avx512f_flag)
    {
        ...
        TestedType &dspl = container.use();
        ret_val =
            TestPhaseHalfPi<TestedType>::perform_test(dspl, coef_arr, ss, "avx512", transition_bw);
    }
    ...
    if(ret_val == 0 && cpu._avx512f_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestUpsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "avx512",
                                                            transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._neon_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestHalfBand<TestedType>::perform_test(dspl, coef_arr, ss, "neon", transition_bw,
                                                         stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._neon_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestDownsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "neon",
                                                              transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._neon_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestDownsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "neonO",
                                                              transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._neon_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestUpsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "neon",
                                                            transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._neon_flag)
    {
        ...
        AlignedObject<TestedType> container;
        TestedType &dspl = container.use();
        ret_val = TestUpsampler2x<TestedType>::perform_test(dspl, coef_arr, ss, "neonO",
                                                            transition_bw, stopband_at);
    }
    ...
    if(ret_val == 0 && cpu._neon_flag)
    {
        ...
        TestedType &dspl = container.use();
        ret_val =
            TestPhaseHalfPi<TestedType>::perform_test(dspl, coef_arr, ss, "neon", transition_bw);
    }
...
void TestAllClassesFnc<NC>::perform_test_r(int &ret_val, double transition_bw)
{
    ...
    if(ret_val == 0) { ret_val = perform_test(transition_bw); }
}
