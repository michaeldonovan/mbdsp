...
public:
    ...
    static int perform_test(TO &uspl, const double coef_arr[_nbr_coefs], const SweepingSine &ss,
...
private:
    ...
    ~TestUpsampler2x() = delete;
    TestUpsampler2x<TO> &operator=(const TestUpsampler2x<TO> &other) = delete;
    TestUpsampler2x<TO> &operator=(TestUpsampler2x<TO> &&other) = delete;
