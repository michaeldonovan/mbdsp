...
private:
    ...
    SpeedTesterBase<TO> &operator=(const SpeedTesterBase<TO> &other) = delete;
    SpeedTesterBase<TO> &operator=(SpeedTesterBase<TO> &&other) = delete;
