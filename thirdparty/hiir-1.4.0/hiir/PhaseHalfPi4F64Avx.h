...
public:
    ...
    PhaseHalfPi4F64Avx<NC> &operator=(const PhaseHalfPi4F64Avx<NC> &other) = default;
    PhaseHalfPi4F64Avx<NC> &operator=(PhaseHalfPi4F64Avx<NC> &&other) = default;

    void set_coefs(const double coef_arr[]) noexcept;

    hiir_FORCEINLINE void process_sample(__m256d &out_0, __m256d &out_1, __m256d input) noexcept;
