...
public:
    ...
    Downsampler2xSseOld<NC> &operator=(const Downsampler2xSseOld<NC> &other) = default;
    Downsampler2xSseOld<NC> &operator=(Downsampler2xSseOld<NC> &&other) = default;
