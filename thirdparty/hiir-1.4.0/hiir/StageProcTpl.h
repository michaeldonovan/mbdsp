...
public:
    static hiir_FORCEINLINE void process_sample_pos(const int nbr_coefs, DT &spl_0, DT &spl_1,
                                                    StageDataTpl<DT> *stage_arr) noexcept;
    static hiir_FORCEINLINE void process_sample_neg(const int nbr_coefs, DT &spl_0, DT &spl_1,
                                                    StageDataTpl<DT> *stage_arr) noexcept;
