...
public:
    static hiir_FORCEINLINE void process_sample_pos(const int nbr_coefs, __m128 &spl_0,
                                                    __m128 &spl_1,
                                                    StageDataSse *stage_arr) noexcept;
    static hiir_FORCEINLINE void process_sample_neg(const int nbr_coefs, __m128 &spl_0,
                                                    __m128 &spl_1,
                                                    StageDataSse *stage_arr) noexcept;
...
private:
    ...
    ~StageProc4Sse() = delete;
    StageProc4Sse<REMAINING> &operator=(const StageProc4Sse<REMAINING> &other) = delete;
    StageProc4Sse<REMAINING> &operator=(StageProc4Sse<REMAINING> &&other) = delete;
