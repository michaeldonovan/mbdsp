...
public:
    static hiir_FORCEINLINE void process_sample_pos(const int nbr_coefs, float32x4_t &spl_0,
                                                    float32x4_t &spl_1,
                                                    StageDataNeonV4 *stage_arr) noexcept;
    static hiir_FORCEINLINE void process_sample_neg(const int nbr_coefs, float32x4_t &spl_0,
                                                    float32x4_t &spl_1,
                                                    StageDataNeonV4 *stage_arr) noexcept;
...
private:
    ...
    ~StageProc4Neon() = delete;
    StageProc4Neon<REMAINING> &operator=(const StageProc4Neon<REMAINING> &other) = delete;
    StageProc4Neon<REMAINING> &operator=(StageProc4Neon<REMAINING> &&other) = delete;
