...
template <int CUR>
void StageProcSseV4<CUR>::process_sample_pos(StageDataSse *stage_ptr, __m128 &y,
                                             __m128 &mem) noexcept
{
...
template <>
hiir_FORCEINLINE void StageProcSseV4<0>::process_sample_pos(StageDataSse * /* stage_ptr */,
                                                            __m128 & /* y */,
                                                            __m128 & /* mem */) noexcept
{
...
template <int CUR>
void StageProcSseV4<CUR>::process_sample_neg(StageDataSse *stage_ptr, __m128 &y,
                                             __m128 &mem) noexcept
{
...
template <>
hiir_FORCEINLINE void StageProcSseV4<0>::process_sample_neg(StageDataSse * /* stage_ptr */,
                                                            __m128 & /* y */,
                                                            __m128 & /* mem */) noexcept
{
    // Nothing, stops the recursion
