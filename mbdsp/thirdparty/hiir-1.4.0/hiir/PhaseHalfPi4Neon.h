...
public:
    ...
    PhaseHalfPi4Neon<NC> &operator=(const PhaseHalfPi4Neon<NC> &other) = default;
    PhaseHalfPi4Neon<NC> &operator=(PhaseHalfPi4Neon<NC> &&other) = default;

    void set_coefs(const double coef_arr[]) noexcept;

    hiir_FORCEINLINE void process_sample(float32x4_t &out_0, float32x4_t &out_1,
