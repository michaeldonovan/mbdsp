...
public:
    ...
    HalfBandSse<NC> &operator=(const HalfBandSse<NC> &other) = default;
    HalfBandSse<NC> &operator=(HalfBandSse<NC> &&other) = default;
...
private:
    ...
    hiir_FORCEINLINE std::array<float, 2> process_2_paths(float input) noexcept;
    ...
    hiir_FORCEINLINE static void store_low(float *ptr, __m128 even, __m128 odd,
                                           __m128 half) noexcept;
    hiir_FORCEINLINE static void store_high(float *ptr, __m128 even, __m128 odd,
                                            __m128 half) noexcept;
    hiir_FORCEINLINE static void bypass(float *, __m128, __m128, __m128) noexcept {}

    // Should be the first member (thus easier to align)
    alignas(16) FilterBiPhase _filter;
    float _prev;
    int _phase;  // 0 or 1
