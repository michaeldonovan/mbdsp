...
template <int NC>
Upsampler2xF64Sse2<NC>::Upsampler2xF64Sse2() noexcept : _filter()
{
...
template <int NC>
void Upsampler2xF64Sse2<NC>::process_block(double out_ptr[], const double in_ptr[],
                                           long nbr_spl) noexcept
{
    ...
    if(n2 < nbr_spl) { process_sample(out_ptr[n2 * 2], out_ptr[n2 * 2 + 1], in_ptr[n2]); }
}
...
template <int NC>
long Upsampler2xF64Sse2<NC>::process_block_double(double out_ptr[], const double in_ptr[],
                                                  long nbr_spl) noexcept
{
