...
template <int NC>
PhaseHalfPi4F64Avx<NC>::PhaseHalfPi4F64Avx() noexcept : _bifilter(), _phase(0)
{
...
void PhaseHalfPi4F64Avx<NC>::process_sample(__m256d &out_0, __m256d &out_1, __m256d input) noexcept
{
    ...
    StageProc4F64Avx<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1, &_bifilter[_phase][0]);
...
template <int NC>
void PhaseHalfPi4F64Avx<NC>::process_block(double out_0_ptr[], double out_1_ptr[],
                                           const double in_ptr[], long nbr_spl) noexcept
{
    ...
    while(pos < end)
    {
        ...
        __m256d out_1 = prev;
        StageProc4F64Avx<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1, &_bifilter[0][0]);
        ...
        out_0 = input_1;
        out_1 = input_0;  // prev
        StageProc4F64Avx<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1, &_bifilter[1][0]);
