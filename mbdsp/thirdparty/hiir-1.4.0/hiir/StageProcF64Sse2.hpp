...
template <>
hiir_FORCEINLINE void StageProcF64Sse2<0>::process_sample_pos_rec(
    __m128d & /*x*/, StageDataF64Sse2 * /*stage_arr*/) noexcept
{
...
template <>
hiir_FORCEINLINE void StageProcF64Sse2<0>::process_sample_neg_rec(
    __m128d & /*x*/, StageDataF64Sse2 * /*stage_arr*/) noexcept
{
    // Nothing, stops the recursion
}
