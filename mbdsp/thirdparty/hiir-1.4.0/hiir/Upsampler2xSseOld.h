...
public:
    ...
    Upsampler2xSseOld<NC> &operator=(const Upsampler2xSseOld<NC> &other) = default;
    Upsampler2xSseOld<NC> &operator=(Upsampler2xSseOld<NC> &&other) = default;
...
private:
    ...
    hiir_FORCEINLINE long process_block_quad(float out_ptr[], const float in_ptr[],
