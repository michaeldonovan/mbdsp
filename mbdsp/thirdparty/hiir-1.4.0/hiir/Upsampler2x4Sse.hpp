...
template <int NC>
Upsampler2x4Sse<NC>::Upsampler2x4Sse() noexcept : _filter()
{
...
void Upsampler2x4Sse<NC>::process_sample(__m128 &out_0, __m128 &out_1, __m128 input) noexcept
{
    __m128 even = input;
    __m128 odd = input;
    StageProc4Sse<NBR_COEFS>::process_sample_pos(NBR_COEFS, even, odd, &_filter[0]);
    out_0 = even;
    out_1 = odd;
}
...
template <int NC>
void Upsampler2x4Sse<NC>::process_block(float out_ptr[], const float in_ptr[],
