...
public:
    static hiir_FORCEINLINE void process_sample_pos(const int nbr_coefs, __m128d &spl_0,
                                                    __m128d &spl_1,
                                                    StageDataF64Sse2 *stage_arr) noexcept;
    static hiir_FORCEINLINE void process_sample_neg(const int nbr_coefs, __m128d &spl_0,
                                                    __m128d &spl_1,
                                                    StageDataF64Sse2 *stage_arr) noexcept;
...
private:
    ...
    ~StageProc2F64Sse2() = delete;
    StageProc2F64Sse2<REMAINING> &operator=(const StageProc2F64Sse2<REMAINING> &other) = delete;
    StageProc2F64Sse2<REMAINING> &operator=(StageProc2F64Sse2<REMAINING> &&other) = delete;
