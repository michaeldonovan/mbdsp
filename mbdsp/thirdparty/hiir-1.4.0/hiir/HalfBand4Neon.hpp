...
template <int NC>
HalfBand4Neon<NC>::HalfBand4Neon() noexcept : _bifilter(), _phase(0)
{
...
template <int NC>
void HalfBand4Neon<NC>::process_block_hpf(float out_ptr[], const float in_ptr[],
...
template <int NC>
void HalfBand4Neon<NC>::process_sample_split(float32x4_t &low, float32x4_t &high,
                                             float32x4_t input) noexcept
{
    const auto path_arr = process_2_paths(input);
...
template <int NC>
void HalfBand4Neon<NC>::process_block_split(float out_l_ptr[], float out_h_ptr[],
...
typename HalfBand4Neon<NC>::EvenOdd HalfBand4Neon<NC>::process_2_paths(float32x4_t input) noexcept
{
    ...
    StageProc4Neon<NBR_COEFS>::process_sample_pos(NBR_COEFS, path_arr._e, path_arr._o,
                                                  &_bifilter[_phase][0]);
...
void HalfBand4Neon<NC>::process_block_2_paths(float out_l_ptr[], float out_h_ptr[],
                                              ...
                                              FH fnc_h) noexcept
{
    ...
    while(pos < end)
    {
        ...
        auto tmp_0 = input_0;
        auto tmp_1 = prev;
        StageProc4Neon<NBR_COEFS>::process_sample_pos(NBR_COEFS, tmp_0, tmp_1, &_bifilter[0][0]);

        auto tmp_2 = input_1;
        auto tmp_3 = input_0;  // prev
        StageProc4Neon<NBR_COEFS>::process_sample_pos(NBR_COEFS, tmp_2, tmp_3, &_bifilter[1][0]);
