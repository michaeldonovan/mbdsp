...
public:
    ...
    PhaseHalfPi8F64Avx512<NC> &operator=(const PhaseHalfPi8F64Avx512<NC> &other) = default;
    PhaseHalfPi8F64Avx512<NC> &operator=(PhaseHalfPi8F64Avx512<NC> &&other) = default;

    void set_coefs(const double coef_arr[]) noexcept;

    hiir_FORCEINLINE void process_sample(__m512d &out_0, __m512d &out_1, __m512d input) noexcept;
    void process_block(double out_0_ptr[], double out_1_ptr[], const double in_ptr[],
