...
public:
    static hiir_FORCEINLINE void process_sample_pos() noexcept;
    static hiir_FORCEINLINE void process_sample_neg() noexcept;
...
private:
    ...
    ~StageProc3dnow() = delete;
    StageProc3dnow &operator=(const StageProc3dnow<CUR> &other) = delete;
    StageProc3dnow &operator=(StageProc3dnow<CUR> &&other) = delete;
