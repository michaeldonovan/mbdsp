...
public:
    ...
    PhaseHalfPi16Avx512<NC> &operator=(const PhaseHalfPi16Avx512<NC> &other) = default;
    PhaseHalfPi16Avx512<NC> &operator=(PhaseHalfPi16Avx512<NC> &&other) = default;

    void set_coefs(const double coef_arr[]) noexcept;

    hiir_FORCEINLINE void process_sample(__m512 &out_0, __m512 &out_1, __m512 input) noexcept;
