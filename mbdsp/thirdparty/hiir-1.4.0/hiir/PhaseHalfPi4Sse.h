...
public:
    ...
    PhaseHalfPi4Sse<NC> &operator=(const PhaseHalfPi4Sse<NC> &other) = default;
    PhaseHalfPi4Sse<NC> &operator=(PhaseHalfPi4Sse<NC> &&other) = default;

    void set_coefs(const double coef_arr[]) noexcept;

    hiir_FORCEINLINE void process_sample(__m128 &out_0, __m128 &out_1, __m128 input) noexcept;
