...
template <int NC>
HalfBandSse<NC>::HalfBandSse() noexcept : _filter(), _prev(0), _phase(0)
{
...
template <int NC>
void HalfBandSse<NC>::process_block_hpf(float out_ptr[], const float in_ptr[],
...
template <int NC>
void HalfBandSse<NC>::process_block_split(float out_l_ptr[], float out_h_ptr[],
...
long HalfBandSse<NC>::process_block_quad(float out_l_ptr[], float out_h_ptr[], const float in_ptr[],
                                         long nbr_spl, FL fnc_l, FH fnc_h) noexcept
{
    assert(_phase == 0);
