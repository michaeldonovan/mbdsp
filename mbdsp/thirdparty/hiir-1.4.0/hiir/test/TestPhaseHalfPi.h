...
public:
    ...
    static int perform_test(TO &phaser, const double coef_arr[_nbr_coefs], const SweepingSine &ss,
                            const char *type_0, double transition_bw);
...
private:
    ...
    ~TestPhaseHalfPi() = delete;
    TestPhaseHalfPi<TO> &operator=(const TestPhaseHalfPi<TO> &other) = delete;
    TestPhaseHalfPi<TO> &operator=(TestPhaseHalfPi<TO> &&other) = delete;
