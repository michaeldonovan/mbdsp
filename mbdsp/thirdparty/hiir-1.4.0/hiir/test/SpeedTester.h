...
template <class AP>
class SpeedTester : public SpeedTesterBase<typename AP::TestedObject>
{
    /*\\\ PUBLIC \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*/
...
private:
    ...
    SpeedTester<AP> &operator=(const SpeedTester<AP> &other) = delete;
    SpeedTester<AP> &operator=(SpeedTester<AP> &&other) = delete;
