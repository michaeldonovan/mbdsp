...
public:
    ...
    {
        tested_obj.process_block(&tester._dest_arr[0][0], &tester._src_arr[0][0],
...
public:
    ...
    static hiir_FORCEINLINE void process_block(SpeedTesterBase<TO> &tester, TO &tested_obj) noexcept
    {
        tested_obj.process_block(&tester._dest_arr[0][0], &tester._dest_arr[1][0],
                                 &tester._src_arr[0][0], tester._block_len / TO::_nbr_chn);
    }
};
...
public:
    ...
    static hiir_FORCEINLINE void process_block(SpeedTesterBase<TO> &tester, TO &tested_obj) noexcept
    {
        tested_obj.process_block_split(&tester._dest_arr[0][0], &tester._dest_arr[1][0],
                                       &tester._src_arr[0][0], tester._block_len / TO::_nbr_chn);
    }
};
