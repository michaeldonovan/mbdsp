...
template <int NC>
Upsampler2x8F64Avx512<NC>::Upsampler2x8F64Avx512() noexcept : _filter()
{
...
template <int NC>
void Upsampler2x8F64Avx512<NC>::process_sample(__m512d &out_0, __m512d &out_1,
                                               __m512d input) noexcept
{
    __m512d even = input;
    __m512d odd = input;
    StageProc8F64Avx512<NBR_COEFS>::process_sample_pos(NBR_COEFS, even, odd, &_filter[0]);
    out_0 = even;
    out_1 = odd;
}
...
template <int NC>
void Upsampler2x8F64Avx512<NC>::process_block(double out_ptr[], const double in_ptr[],
