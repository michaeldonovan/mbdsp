...
template <int NC>
Downsampler2x4F64Avx<NC>::Downsampler2x4F64Avx() noexcept : _filter()
{
...
void Downsampler2x4F64Avx<NC>::set_coefs(const double coef_arr[]) noexcept
{
    ...
    {
        _mm256_store_pd(_filter[i + 2]._coef, _mm256_set1_pd(DataType(coef_arr[i])));
    }
}
...
__m256d Downsampler2x4F64Avx<NC>::process_sample(__m256d in_0, __m256d in_1) noexcept
{
    ...
    StageProc4F64Avx<NBR_COEFS>::process_sample_pos(NBR_COEFS, spl_0, spl_1, &_filter[0]);
...
template <int NC>
void Downsampler2x4F64Avx<NC>::process_block(double out_ptr[], const double in_ptr[],
...
template <int NC>
void Downsampler2x4F64Avx<NC>::process_sample_split(__m256d &low, __m256d &high,
...
template <int NC>
void Downsampler2x4F64Avx<NC>::process_sample_split(__m256d &low, __m256d &high, __m256d in_0,
...
template <int NC>
void Downsampler2x4F64Avx<NC>::process_block_split(double out_l_ptr[], double out_h_ptr[],
