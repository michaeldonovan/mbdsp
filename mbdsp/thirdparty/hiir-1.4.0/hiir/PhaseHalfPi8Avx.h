...
public:
    ...
    PhaseHalfPi8Avx<NC> &operator=(const PhaseHalfPi8Avx<NC> &other) = default;
    PhaseHalfPi8Avx<NC> &operator=(PhaseHalfPi8Avx<NC> &&other) = default;

    void set_coefs(const double coef_arr[]) noexcept;

    hiir_FORCEINLINE void process_sample(__m256 &out_0, __m256 &out_1, __m256 input) noexcept;
