...
template <int NC>
PhaseHalfPi8F64Avx512<NC>::PhaseHalfPi8F64Avx512() noexcept : _bifilter(), _phase(0)
{
...
template <int NC>
void PhaseHalfPi8F64Avx512<NC>::process_sample(__m512d &out_0, __m512d &out_1,
                                               __m512d input) noexcept
{
    out_0 = input;                  // Even coefs
    out_1 = _mm512_load_pd(_prev);  // Odd coefs

    StageProc8F64Avx512<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1,
                                                       &_bifilter[_phase][0]);
...
template <int NC>
void PhaseHalfPi8F64Avx512<NC>::process_block(double out_0_ptr[], double out_1_ptr[],
