...
public:
    ...
    Upsampler2xF64Sse2<NC> &operator=(const Upsampler2xF64Sse2<NC> &other) = default;
    Upsampler2xF64Sse2<NC> &operator=(Upsampler2xF64Sse2<NC> &&other) = default;

    void set_coefs(const double coef_arr[]) noexcept;

    hiir_FORCEINLINE void process_sample(double &out_0, double &out_1, double input) noexcept;
...
private:
    ...
    hiir_FORCEINLINE long process_block_double(double out_ptr[], const double in_ptr[],
