...
template <int NC>
PhaseHalfPi8Avx<NC>::PhaseHalfPi8Avx() noexcept : _bifilter(), _phase(0)
{
...
void PhaseHalfPi8Avx<NC>::process_sample(__m256 &out_0, __m256 &out_1, __m256 input) noexcept
{
    ...
    StageProc8Avx<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1, &_bifilter[_phase][0]);
...
template <int NC>
void PhaseHalfPi8Avx<NC>::process_block(float out_0_ptr[], float out_1_ptr[], const float in_ptr[],
                                        long nbr_spl) noexcept
{
    ...
    while(pos < end)
    {
        ...
        __m256 out_1 = prev;
        StageProc8Avx<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1, &_bifilter[0][0]);
        ...
        out_0 = input_1;
        out_1 = input_0;  // prev
        StageProc8Avx<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1, &_bifilter[1][0]);
