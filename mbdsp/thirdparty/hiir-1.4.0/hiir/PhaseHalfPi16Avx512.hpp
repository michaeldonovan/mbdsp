...
template <int NC>
PhaseHalfPi16Avx512<NC>::PhaseHalfPi16Avx512() noexcept : _bifilter(), _phase(0)
{
...
void PhaseHalfPi16Avx512<NC>::process_sample(__m512 &out_0, __m512 &out_1, __m512 input) noexcept
{
    ...
    StageProc16Avx512<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1,
                                                     &_bifilter[_phase][0]);
...
template <int NC>
void PhaseHalfPi16Avx512<NC>::process_block(float out_0_ptr[], float out_1_ptr[],
                                            const float in_ptr[], long nbr_spl) noexcept
{
    ...
    while(pos < end)
    {
        ...
        __m512 out_1 = prev;
        StageProc16Avx512<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1, &_bifilter[0][0]);
        ...
        out_0 = input_1;
        out_1 = input_0;  // prev
        StageProc16Avx512<NBR_COEFS>::process_sample_neg(NBR_COEFS, out_0, out_1, &_bifilter[1][0]);
